...
abstract class $TypeEntityCopyWith<$Res> {
  ...
  @useResult
  $Res call({String arabic, String latin});
}
...
class _$TypeEntityImpl implements _TypeEntity {
  const _$TypeEntityImpl({required this.arabic, required this.latin});
  ...
  @override
  String toString() {
    return 'TypeEntity(arabic: $arabic, latin: $latin)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, arabic, latin);
...
abstract class _TypeEntity implements TypeEntity {
  const factory _TypeEntity(
      ...
      required final String latin}) = _$TypeEntityImpl;
